 ...
 */
final class Version20250429082353 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE meal_plan (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, recipe_id INT NOT NULL, meal_date DATETIME NOT NULL, INDEX IDX_C7848889A76ED395 (user_id), INDEX IDX_C784888959D8A214 (recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, ingredients LONGTEXT NOT NULL, preparation_time INT NOT NULL, calories INT NOT NULL, is_vegetarian TINYINT(1) NOT NULL, is_vegan TINYINT(1) NOT NULL, allergens LONGTEXT NOT NULL, nutrients LONGTEXT NOT NULL, external_link VARCHAR(255) DEFAULT NULL, approved_by_admin TINYINT(1) NOT NULL, average_rating DOUBLE PRECISION NOT NULL, INDEX IDX_DA88B137B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE shopping_list (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, ingredients_list LONGTEXT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_3DC1A459A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
